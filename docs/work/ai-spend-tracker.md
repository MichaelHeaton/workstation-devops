...
Adobe-internal menu-bar app for tracking AI API spend. **Source** is private ([Adobe-CloudEngg/ai-spend-tracker](https://github.com/Adobe-CloudEngg/ai-spend-tracker) — Adobe GitHub SSO). **Binaries and Sparkle updates** are public so installs and auto-update work without SSO.

| What | URL | SSO? |
|------|-----|------|
| Source / PRs | [Adobe-CloudEngg/ai-spend-tracker](https://github.com/Adobe-CloudEngg/ai-spend-tracker) | Yes |
